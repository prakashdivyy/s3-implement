    ...
    <div class="container">
        ...
        <div class="row center">
            ...
            foreach ($Objects as $Object) {
                echo "<a href='https://grup2-ceph-04.sisdis.ui.ac.id/" . BUCKET_NAME . "/" . $Object->Key . "'> " . $Object->Key . "</a>";
                echo "<a href='http://grup2-ceph-04.sisdis.ui.ac.id/imp-s3/copy/" . $Object->Key . "'><i class='material-icons'>content_copy</i></a>";
...
<?php if ($Copy === 2) { ?>
    <script>
        var $toastContent = $('<span>Cannot copy, file <?php echo $filename; ?> exist</span>');
        Materialize.toast($toastContent, 3000);
    </script>
<?php } ?>
<?php if ($Copy === 3) { ?>
    <script>
        var $toastContent = $('<span>File <?php echo $filename; ?> has succesfully been copied</span>');
        Materialize.toast($toastContent, 3000);
    </script>
<?php } ?>
<?php if ($Copy === 4) { ?>
    <script>
        var $toastContent = $('<span>Failed to copy file <?php echo $filename; ?></span>');
        Materialize.toast($toastContent, 3000);
    </script>
<?php } ?>
</body>
