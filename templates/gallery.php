  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">Kelompok 2 Sisdis</a>
      <ul class="right hide-on-med-and-down">
            <li><a href="grup2-ceph-04.sisdis.ui.ac.id/imp-s3/">Home</a></li>
            <li><a href="grup2-ceph-04.sisdis.ui.ac.id/imp-s3/gallery">Gallery</a></li>
            <li><a href="grup2-ceph-04.sisdis.ui.ac.id/imp-swift/">Swift</a></li>
        </ul>
